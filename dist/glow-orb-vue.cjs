...
function r(e) {
  const n = Math.max(0, e.excitement),
    r = Math.max(0, e.warp),
    i = t(e.env, 0, 1),
    a = e.time * n - e.blobIndex * e.phase,
    o =
      Math.sin(a * 0.31) * 18 * n +
      Math.sin(a * 0.83) * 9 * n +
      Math.cos(a * 0.17) * 6 * n,
    s = Math.cos(a * 0.26) * 16 * n + Math.sin(a * 0.69) * 8 * n - i * 8,
    c = Math.sin(a * 0.19) * 120 * r + Math.sin(a * 0.53) * 30 * r,
    l = 1.1 + 0.3 * n * Math.sin(a * 0.47) + i * 0.08,
    u = 1.1 + 0.3 * n * Math.sin(a * 0.61 + 2.1) + i * 0.3,
    d = 50 + 22 * r * Math.sin(a * 0.41),
    f = 50 + 22 * r * Math.sin(a * 0.57 + 1.4),
    p = 50 + 22 * r * Math.sin(a * 0.33 + 2.9),
    m = 50 + 22 * r * Math.sin(a * 0.71 + 4.2);
  return {
    x: o,
    y: s,
    rotation: c,
...
var i = (e, t) => {
  ...
  o = (e) => i(a[e.toLowerCase()], 6),
  s = /^#?([0-9a-f]{8}|[0-9a-f]{6}|[0-9a-f]{4}|[0-9a-f]{3})$/i,
  c = (e) => {
    let t;
    return (t = e.match(s)) ? i(parseInt(t[1], 16), t[1].length) : void 0;
  },
  l = `([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)`;
`${l}`;
var u = `${l}%`;
...
var d = `(?:${l}%|${l})`,
  f = `(?:${l}%|${l}|none)`,
  p = `(?:${l}(deg|grad|rad|turn)|${l})`;
`${l}${l}`;
var m = `\\s*,\\s*`;
RegExp(`^` + f + `$`);
var h = RegExp(`^rgba?\\(\\s*${l}${m}${l}${m}${l}\\s*(?:,\\s*${d}\\s*)?\\)$`),
  g = RegExp(`^rgba?\\(\\s*${u}${m}${u}${m}${u}\\s*(?:,\\s*${d}\\s*)?\\)$`),
  _ = (e) => {
    let t = { mode: `rgb` },
      n;
    if ((n = e.match(h)))
  ...
  w = (e) => (
    ...
    e.channels.forEach((t) => {
      ...
      typeof e.interpolate[t] == `function` &&
        ...
        e.interpolate[t].fixup || (e.interpolate[t].fixup = ee);
    }),
    (x[e.mode] = e),
    (e.parse || []).forEach((t) => {
      ne(t, e.mode);
  ...
  ne = (e, t) => {
    if (typeof e == `string`) {
      ...
      C[e] = t;
    } else typeof e == `function` && S.indexOf(e) < 0 && S.push(e);
  },
  T = /[^\x00-\x7F]|[a-zA-Z_]/,
  re = /[^\x00-\x7F]|[-\w]/,
  E = {
...
function k(e) {
  ...
  if (t === `-`) {
    if (e.length - D < 2) return !1;
    const t = e[D + 1];
    return !!(t === `-` || T.test(t));
  }
  return !1;
}
var ie = { deg: 1, rad: 180 / Math.PI, grad: 9 / 10, turn: 360 };
function A(e) {
  let t = ``;
  if (
    ((e[D] === `-` || e[D] === `+`) && (t += e[D++]),
    (t += j(e)),
    e[D] === `.` && /\d/.test(e[D + 1]) && (t += e[D++] + j(e)),
    (e[D] === `e` || e[D] === `E`) &&
      ((e[D + 1] === `-` || e[D + 1] === `+`) && /\d/.test(e[D + 2])
        ? (t += e[D++] + e[D++] + j(e))
        : /\d/.test(e[D + 1]) && (t += e[D++] + j(e))),
    k(e))
  ) {
    const n = M(e);
    return n === `deg` || n === `rad` || n === `turn` || n === `grad`
      ? { type: E.Hue, value: t * ie[n] }
      : void 0;
  }
  return e[D] === `%`
    ? (D++, { type: E.Percentage, value: +t })
    : { type: E.Number, value: +t };
}
function j(e) {
  let t = ``;
  for (; /\d/.test(e[D]); ) t += e[D++];
  return t;
}
function M(e) {
  let t = ``;
  for (; D < e.length && re.test(e[D]); ) t += e[D++];
  return t;
}
function N(e) {
  const t = M(e);
  return e[D] === `(`
    ? (D++, { type: E.Function, value: t })
    : t === `none`
      ? { type: E.None, value: void 0 }
      : { type: E.Ident, value: t };
}
function ae(e = ``) {
  let t = e.trim(),
    n = [],
...
` ||
        ...
        D++;
      let e;
      if (O(t) && ((e = A(t)), e.type !== E.Hue)) {
        n.push({ type: E.Alpha, value: e });
        continue;
      }
      if (k(t) && M(t) === `none`) {
        n.push({ type: E.Alpha, value: { type: E.None, value: void 0 } });
        continue;
      }
      return;
    }
...
function oe(e) {
  ...
  const r = { mode: n },
    i = se(e, !1);
  if (!i) return;
  const a = te(n).channels;
  for (let e = 0, t, n; e < a.length; e++)
    (t = i[e]),
      (n = a[e]),
      t.type !== E.None &&
        ((r[n] = t.type === E.Number ? t.value : t.value / 100),
...
function se(e, t) {
  ...
  if (!(n.length < 3 || n.length > 4)) {
    if (n.length === 4) {
      if (n[3].type !== E.Alpha) return;
      n[3] = n[3].value;
    }
    return (
      n.length === 3 && n.push({ type: E.None, value: void 0 }),
      n.every((e) => e.type !== E.Alpha) ? n : void 0
    );
  }
}
function ce(e, t) {
...
var le = (e) => {
  ...
  let t = ae(e),
    ...
    i = 0,
    a = S.length;
  for (; i < a; ) if ((r = S[i++](e, n)) !== void 0) return r;
...
function ue(e, t) {
  ...
  const n = { mode: `rgb` },
    [, r, i, a, o] = t;
  if (r.type !== E.Hue && i.type !== E.Hue && a.type !== E.Hue)
    return (
      r.type !== E.None &&
        (n.r = r.type === E.Number ? r.value / 255 : r.value / 100),
      i.type !== E.None &&
        (n.g = i.type === E.Number ? i.value / 255 : i.value / 100),
      a.type !== E.None &&
        (n.b = a.type === E.Number ? a.value / 255 : a.value / 100),
      o.type !== E.None &&
        (n.alpha = Math.min(
          1,
          Math.max(0, o.type === E.Number ? o.value : o.value / 100)
        )),
      n
    );
}
var de = (e) =>
    e === `transparent` ? { mode: `rgb`, r: 0, g: 0, b: 0, alpha: 0 } : void 0,
  fe = (e, t, n) => e + n * (t - e),
  pe = (e) => {
    const t = [];
  ...
  I = {
    ...
    parse: [ue, c, _, o, de, `srgb`],
    serialize: `srgb`,
    interpolate: { r: P, g: P, b: P, alpha: { use: P, fixup: F } },
    gamut: !0,
    white: { r: 1, g: 1, b: 1 },
    black: { r: 0, g: 0, b: 0 },
  },
  me = (e = 0) => Math.abs(e) ** (563 / 256) * Math.sign(e),
  he = (e) => {
    const t = me(e.r),
      n = me(e.g),
      r = me(e.b),
  ...
  ge = (e) => Math.abs(e) ** (256 / 563) * Math.sign(e),
  _e = ({ x: e, y: t, z: n, alpha: r }) => {
  ...
  L = ({ r: e, g: t, b: n, alpha: r }) => {
    const i = { mode: `lrgb`, r: ve(e), g: ve(t), b: ve(n) };
    return r !== void 0 && (i.alpha = r), i;
  },
  R = (e) => {
    const { r: t, g: n, b: r, alpha: i } = L(e),
      a = {
        mode: `xyz65`,
        x:
  ...
  z = ({ r: e, g: t, b: n, alpha: r }, i = `rgb`) => {
    const a = { mode: i, r: ye(e), g: ye(t), b: ye(n) };
  ...
  be = {
    ...
    parse: [`a98-rgb`],
    serialize: `a98-rgb`,
    fromMode: { rgb: (e) => _e(R(e)), xyz65: _e },
    toMode: { rgb: (e) => B(he(e)), xyz65: he },
  },
  V = (e) => ((e %= 360) < 0 ? e + 360 : e),
  xe = (e, t) =>
    e
  ...
  H = (e) => xe(e, (e) => (Math.abs(e) <= 180 ? e : e - 360 * Math.sign(e))),
  U = [-0.14861, 1.78277, -0.29227, -0.90649, 1.97294, 0],
  Se = Math.PI / 180,
  Ce = 180 / Math.PI,
  we = U[3] * U[4],
  Te = U[1] * U[4],
  Ee = U[1] * U[2] - U[0] * U[3],
  De = ({ r: e, g: t, b: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = (Ee * n + e * we - t * Te) / (Ee + we - Te),
      a = n - i,
      o = (U[4] * (t - i) - U[2] * a) / U[3],
      s = {
        mode: `cubehelix`,
        ...
        s:
          i === 0 || i === 1
            ? void 0
            : Math.sqrt(a * a + o * o) / (U[4] * i * (1 - i)),
      };
    return (
      s.s && (s.h = Math.atan2(o, a) * Ce - 120),
      r !== void 0 && (s.alpha = r),
      s
    );
  },
  Oe = ({ h: e, s: t, l: n, alpha: r }) => {
    const i = { mode: `rgb` };
    (e = (e === void 0 ? 0 : e + 120) * Se), n === void 0 && (n = 0);
  ...
  G = ({ l: e, a: t, b: n, alpha: r }, i = `lch`) => {
    ...
    const a = Math.sqrt(t * t + n * n),
      o = { mode: i, l: e, c: a };
    return (
      a && (o.h = V((Math.atan2(n, t) * 180) / Math.PI)),
      r !== void 0 && (o.alpha = r),
      o
    );
  },
  ...
  Ne = 29 ** 3 / 3 ** 3,
  Pe = 6 ** 3 / 29 ** 3,
  q = { X: 0.3457 / 0.3585, Y: 1, Z: 0.2958 / 0.3585 },
  J = { X: 0.3127 / 0.329, Y: 1, Z: 0.3583 / 0.329 },
  Fe = (e) => (e ** 3 > Pe ? e ** 3 : (116 * e - 16) / Ne),
  Ie = ({ l: e, a: t, b: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = (e + 16) / 116,
      a = t / 500 + i,
      o = i - n / 200,
      s = { mode: `xyz65`, x: Fe(a) * J.X, y: Fe(i) * J.Y, z: Fe(o) * J.Z };
    return r !== void 0 && (s.alpha = r), s;
  },
  Le = (e) => B(Ie(e)),
  Re = (e) => (e > Pe ? Math.cbrt(e) : (Ne * e + 16) / 116),
  ze = ({ x: e, y: t, z: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = Re(e / J.X),
      a = Re(t / J.Y),
      o = Re(n / J.Z),
  ...
  Ve = Math.cos(Y),
  He = Math.sin(Y),
  Ue = 100 / Math.log(139 / 100),
  We = ({ l: e, c: t, h: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = { mode: `lab65`, l: (Math.exp((e * 1) / Ue) - 1) / 0.0039 },
      a = (Math.exp(0.0435 * t * 1 * 1) - 1) / 0.075,
      o = a * Math.cos((n / 180) * Math.PI - Y),
      s = a * Math.sin((n / 180) * Math.PI - Y);
    return (
      (i.a = o * Ve - (s / 0.83) * He),
      (i.b = o * He + (s / 0.83) * Ve),
      r !== void 0 && (i.alpha = r),
  ...
  Ge = ({ l: e, a: t, b: n, alpha: r }) => {
    ...
    const i = t * Ve + n * He,
      ...
      s = {
        mode: `dlch`,
        l: (Ue / 1) * Math.log(1 + 0.0039 * e),
        c: Math.log(1 + 0.075 * o) / 0.0435,
      };
    return (
      s.c && (s.h = V(((Math.atan2(a, i) + Y) / Math.PI) * 180)),
      r !== void 0 && (s.alpha = r),
      s
    );
  },
  ...
  Je = {
    ...
    toMode: { lab65: Ke, rgb: (e) => Le(Ke(e)) },
    fromMode: { lab65: qe, rgb: (e) => qe(Be(e)) },
    channels: [`l`, `a`, `b`, `alpha`],
    ranges: { l: [0, 100], a: [-40.09, 45.501], b: [-40.469, 44.344] },
    interpolate: { l: P, a: P, b: P, alpha: { use: P, fixup: F } },
  },
  Ye = {
    mode: `dlch`,
    parse: [`--din99o-lch`],
    serialize: `--din99o-lch`,
    toMode: { lab65: We, dlab: (e) => K(e, `dlab`), rgb: (e) => Le(We(e)) },
    fromMode: { lab65: Ge, dlab: (e) => G(e, `dlch`), rgb: (e) => Ge(Be(e)) },
...
function Xe({ h: e, s: t, i: n, alpha: r }) {
  (e = V(e === void 0 ? 0 : e)),
    t === void 0 && (t = 0),
    n === void 0 && (n = 0);
...
function Ze({ r: e, g: t, b: n, alpha: r }) {
  e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
...
function $e({ h: e, s: t, l: n, alpha: r }) {
  (e = V(e === void 0 ? 0 : e)),
    t === void 0 && (t = 0),
    n === void 0 && (n = 0);
...
function et({ r: e, g: t, b: n, alpha: r }) {
  e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
  const i = Math.max(e, t, n),
    a = Math.min(e, t, n),
    o = {
...
var tt = (e, t) => {
  ...
  nt = RegExp(`^hsla?\\(\\s*${p}${m}${u}${m}${u}\\s*(?:,\\s*${d}\\s*)?\\)$`),
  rt = (e) => {
    const t = e.match(nt);
    if (!t) return;
    const n = { mode: `hsl` };
    return (
      t[3] === void 0
        ? t[1] !== void 0 && t[2] !== void 0 && (n.h = tt(t[1], t[2]))
        : (n.h = +t[3]),
...
function it(e, t) {
  ...
  const n = { mode: `hsl` },
    [, r, i, a, o] = t;
  if (r.type !== E.None) {
    if (r.type === E.Percentage) return;
    n.h = r.value;
  }
  if (i.type !== E.None) {
    if (i.type === E.Hue) return;
    n.s = i.value / 100;
  }
  if (a.type !== E.None) {
    if (a.type === E.Hue) return;
    n.l = a.value / 100;
  }
  return (
    o.type !== E.None &&
...
function ot({ h: e, s: t, v: n, alpha: r }) {
  (e = V(e === void 0 ? 0 : e)),
    t === void 0 && (t = 0),
    n === void 0 && (n = 0);
  let i = Math.abs(((e / 60) % 2) - 1),
  ...
  switch (Math.floor(e / 60)) {
    case 0:
      a = { r: n, g: n * (1 - t * i), b: n * (1 - t) };
      break;
    case 1:
      a = { r: n * (1 - t * i), g: n, b: n * (1 - t) };
      break;
    case 2:
      a = { r: n * (1 - t), g: n, b: n * (1 - t * i) };
      break;
    case 3:
      a = { r: n * (1 - t), g: n * (1 - t * i), b: n };
      break;
    case 4:
      a = { r: n * (1 - t * i), g: n * (1 - t), b: n };
      break;
    case 5:
      a = { r: n, g: n * (1 - t), b: n * (1 - t * i) };
      break;
    default:
      a = { r: n * (1 - t), g: n * (1 - t), b: n * (1 - t) };
  }
...
function st({ r: e, g: t, b: n, alpha: r }) {
  e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
  const i = Math.max(e, t, n),
    a = Math.min(e, t, n),
    o = { mode: `hsv`, s: i === 0 ? 0 : 1 - a / i, v: i };
  return (
    i - a !== 0 &&
      (o.h =
        (i === e
...
function lt({ h: e, w: t, b: n, alpha: r }) {
  if ((t === void 0 && (t = 0), n === void 0 && (n = 0), t + n > 1)) {
    const e = t + n;
    (t /= e), (n /= e);
  }
  return ot({ h: e, s: n === 1 ? 1 : 1 - t / (1 - n), v: 1 - n, alpha: r });
}
function ut(e) {
  const t = st(e);
  if (t === void 0) return;
...
function vt(e) {
  if (e < 0) return 0;
  const t = e ** (1 / mt);
  return 1e4 * (Math.max(0, t - ht) / (gt - _t * t)) ** (1 / pt);
}
function yt(e) {
  if (e < 0) return 0;
  const t = (e / 1e4) ** pt;
  return ((ht + gt * t) / (1 + _t * t)) ** +mt;
}
var bt = (e) => Math.max(e / 203, 0),
  xt = ({ i: e, t, p: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = vt(e + 0.008609037037932761 * t + 0.11102962500302593 * n),
      a = vt(e - 0.00860903703793275 * t - 0.11102962500302599 * n),
      o = vt(e + 0.5600313357106791 * t - 0.32062717498731885 * n),
      s = {
        mode: `xyz65`,
        x: bt(
          2.070152218389422 * i -
  ...
  St = (e = 0) => Math.max(e * 203, 0),
  Ct = ({ x: e, y: t, z: n, alpha: r }) => {
    const i = St(e),
      a = St(t),
      o = St(n),
      s = yt(
  ...
  wt = {
    ...
    parse: [`--ictcp`],
    serialize: `--ictcp`,
    toMode: { xyz65: xt, rgb: (e) => B(xt(e)) },
    fromMode: { xyz65: Ct, rgb: (e) => Ct(R(e)) },
    ranges: { i: [0, 0.581], t: [-0.369, 0.272], p: [-0.164, 0.331] },
    interpolate: { i: P, t: P, p: P, alpha: { use: P, fixup: F } },
  },
  Tt = 134.03437499999998,
  Et = 16295499532821565e-27,
  Dt = (e) => {
    if (e < 0) return 0;
    const t = (e / 1e4) ** pt;
    return ((ht + gt * t) / (1 + _t * t)) ** +Tt;
  },
  Ot = (e = 0) => Math.max(e * 203, 0),
  kt = ({ x: e, y: t, z: n, alpha: r }) => {
    (e = Ot(e)), (t = Ot(t)), (n = Ot(n));
    const i = 1.15 * e - 0.15 * n,
      a = 0.66 * t + 0.34 * e,
      o = Dt(0.41478972 * i + 0.579999 * a + 0.014648 * n),
      s = Dt(-0.20151 * i + 1.120649 * a + 0.0531008 * n),
      c = Dt(-0.0166008 * i + 0.2648 * a + 0.6684799 * n),
      l = (o + s) / 2,
      u = {
        mode: `jab`,
        j: (0.44 * l) / (1 - 0.56 * l) - Et,
        a: 3.524 * o - 4.066708 * s + 0.542708 * c,
        b: 0.199076 * o + 1.096799 * s - 1.295875 * c,
      };
    return r !== void 0 && (u.alpha = r), u;
  },
  At = 134.03437499999998,
  jt = 16295499532821565e-27,
  Mt = (e) => {
    if (e < 0) return 0;
    const t = e ** (1 / At);
    return 1e4 * ((ht - t) / (_t * t - gt)) ** (1 / pt);
  },
  Nt = (e) => e / 203,
  Pt = ({ j: e, a: t, b: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = (e + jt) / (0.44 + 0.56 * (e + jt)),
      a = Mt(i + 0.13860504 * t + 0.058047316 * n),
      o = Mt(i - 0.13860504 * t - 0.058047316 * n),
      s = Mt(i - 0.096019242 * t - 0.8118919 * n),
      c = {
        mode: `xyz65`,
        x: Nt(
          1.661373024652174 * a -
  ...
  Lt = {
    ...
    parse: [`--jzazbz`],
    serialize: `--jzazbz`,
    fromMode: { rgb: Ft, xyz65: kt },
    toMode: { rgb: It, xyz65: Pt },
    ranges: { j: [0, 0.222], a: [-0.109, 0.129], b: [-0.185, 0.134] },
    interpolate: { j: P, a: P, b: P, alpha: { use: P, fixup: F } },
  },
  Rt = ({ j: e, a: t, b: n, alpha: r }) => {
    ...
    const i = Math.sqrt(t * t + n * n),
      a = { mode: `jch`, j: e, c: i };
    return (
      i && (a.h = V((Math.atan2(n, t) * 180) / Math.PI)),
      r !== void 0 && (a.alpha = r),
      a
    );
  },
  zt = ({ j: e, c: t, h: n, alpha: r }) => {
    n === void 0 && (n = 0);
    const i = {
      mode: `jab`,
      j: e,
  ...
  Bt = {
    ...
    parse: [`--jzczhz`],
    serialize: `--jzczhz`,
    toMode: { jab: zt, rgb: (e) => It(zt(e)) },
    fromMode: { rgb: (e) => Rt(Ft(e)), jab: Rt },
  ...
  Vt = 29 ** 3 / 3 ** 3,
  Ht = 6 ** 3 / 29 ** 3,
  Ut = (e) => (e ** 3 > Ht ? e ** 3 : (116 * e - 16) / Vt),
  Wt = ({ l: e, a: t, b: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = (e + 16) / 116,
      a = t / 500 + i,
      o = i - n / 200,
      s = { mode: `xyz50`, x: Ut(a) * q.X, y: Ut(i) * q.Y, z: Ut(o) * q.Z };
    return r !== void 0 && (s.alpha = r), s;
  },
  ...
  Kt = (e) => (e > Ht ? Math.cbrt(e) : (Vt * e + 16) / 116),
  qt = ({ x: e, y: t, z: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = Kt(e / q.X),
      a = Kt(t / q.Y),
      o = Kt(n / q.Z),
      s = { mode: `lab`, l: 116 * a - 16, a: 500 * (i - a), b: 200 * (a - o) };
    return r !== void 0 && (s.alpha = r), s;
  },
  Jt = (e) => {
    const t = qt(Z(e));
...
function Yt(e, t) {
  ...
  if (r.type !== E.Hue && i.type !== E.Hue && a.type !== E.Hue)
    return (
      r.type !== E.None && (n.l = Math.min(Math.max(0, r.value), 100)),
      i.type !== E.None &&
        (n.a = i.type === E.Number ? i.value : (i.value * 125) / 100),
      a.type !== E.None &&
        (n.b = a.type === E.Number ? a.value : (a.value * 125) / 100),
      o.type !== E.None &&
        (n.alpha = Math.min(
          1,
          Math.max(0, o.type === E.Number ? o.value : o.value / 100)
...
var Xt = {
    mode: `lab`,
    toMode: { xyz50: Wt, rgb: Gt },
    fromMode: { xyz50: qt, rgb: Jt },
    channels: [`l`, `a`, `b`, `alpha`],
  ...
  Zt = {
    ...
    parse: [`--lab-d65`],
    serialize: `--lab-d65`,
    toMode: { xyz65: Ie, rgb: Le },
    fromMode: { xyz65: ze, rgb: Be },
    ranges: { l: [0, 100], a: [-125, 125], b: [-125, 125] },
  };
function Qt(e, t) {
  if (!t || t[0] !== `lch`) return;
  ...
  if (
    (i.type !== E.None &&
      (n.c = Math.max(
        0,
        i.type === E.Number ? i.value : (i.value * 150) / 100
      )),
    a.type !== E.None)
  ) {
    if (a.type === E.Percentage) return;
    n.h = a.value;
  }
  return (
    o.type !== E.None &&
...
var $t = {
    mode: `lch`,
    toMode: { lab: K, rgb: (e) => Gt(K(e)) },
    fromMode: { rgb: (e) => G(Jt(e)), lab: G },
    channels: [`l`, `c`, `h`, `alpha`],
  ...
  en = {
    ...
    parse: [`--lch-d65`],
    serialize: `--lch-d65`,
    toMode: { lab65: (e) => K(e, `lab65`), rgb: (e) => Le(K(e, `lab65`)) },
    fromMode: { rgb: (e) => G(Be(e), `lch65`), lab65: (e) => G(e, `lch65`) },
    ranges: { l: [0, 100], c: [0, 150], h: [0, 360] },
  },
  tn = ({ l: e, u: t, v: n, alpha: r }) => {
    t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = Math.sqrt(t * t + n * n),
      a = { mode: `lchuv`, l: e, c: i };
    return (
      i && (a.h = V((Math.atan2(n, t) * 180) / Math.PI)),
      r !== void 0 && (a.alpha = r),
      a
  ...
  rn = (e, t, n) => (4 * e) / (e + 15 * t + 3 * n),
  an = (e, t, n) => (9 * t) / (e + 15 * t + 3 * n),
  on = rn(q.X, q.Y, q.Z),
  sn = an(q.X, q.Y, q.Z),
  cn = (e) => (e <= Ht ? Vt * e : 116 * Math.cbrt(e) - 16),
  ln = ({ x: e, y: t, z: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    let i = cn(t / q.Y),
      a = rn(e, t, n),
      o = an(e, t, n);
    !isFinite(a) || !isFinite(o)
      ? (i = a = o = 0)
      : ((a = 13 * i * (a - on)), (o = 13 * i * (o - sn)));
    const s = { mode: `luv`, l: i, u: a, v: o };
    return r !== void 0 && (s.alpha = r), s;
  },
  un = (e, t, n) => (4 * e) / (e + 15 * t + 3 * n),
  dn = (e, t, n) => (9 * t) / (e + 15 * t + 3 * n),
  fn = un(q.X, q.Y, q.Z),
  pn = dn(q.X, q.Y, q.Z),
  mn = ({ l: e, u: t, v: n, alpha: r }) => {
    if ((e === void 0 && (e = 0), e === 0))
      return { mode: `xyz50`, x: 0, y: 0, z: 0 };
    t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = t / (13 * e) + fn,
      a = n / (13 * e) + pn,
      o = q.Y * (e <= 8 ? e / Vt : ((e + 16) / 116) ** 3),
      s = {
        mode: `xyz50`,
        x: (9 * i * o) / (4 * a),
        y: o,
  ...
  hn = {
    mode: `lchuv`,
    toMode: { luv: nn, rgb: (e) => X(mn(nn(e))) },
    fromMode: { rgb: (e) => tn(ln(Z(e))), luv: tn },
    channels: [`l`, `c`, `h`, `alpha`],
    parse: [`--lchuv`],
    serialize: `--lchuv`,
  ...
  _n = {
    mode: `luv`,
    toMode: { xyz50: mn, rgb: (e) => X(mn(e)) },
    fromMode: { xyz50: ln, rgb: (e) => ln(Z(e)) },
    channels: [`l`, `u`, `v`, `alpha`],
    parse: [`--luv`],
    serialize: `--luv`,
    ranges: { l: [0, 100], u: [-84.936, 175.042], v: [-125.882, 87.243] },
    interpolate: { l: P, u: P, v: P, alpha: { use: P, fixup: F } },
  },
  vn = ({ r: e, g: t, b: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = Math.cbrt(
    ...
    o = (a[1] * (i - 1)) / (r * (a[0] - 1) + a[1] * (i - n));
    {
        ...
        p = a + s * u;
      {
        let e = i * (1 - o) + o * n,
          ...
          S = 6 * f * f * s,
          C = 6 * p * p * m,
          ee = 4.0767416621 * h - 3.3077115913 * g + 0.2309699292 * _ - 1,
          w = 4.0767416621 * v - 3.3077115913 * y + 0.2309699292 * b,
          te = 4.0767416621 * x - 3.3077115913 * S + 0.2309699292 * C,
          ne = w / (w * w - 0.5 * ee * te),
          T = -ee * ne,
          re = -1.2684380046 * h + 2.6097574011 * g - 0.3413193965 * _ - 1,
          E = -1.2684380046 * v + 2.6097574011 * y - 0.3413193965 * b,
          D = -1.2684380046 * x + 2.6097574011 * S - 0.3413193965 * C,
          O = E / (E * E - 0.5 * re * D),
          k = -re * O,
          ie = -0.0041960863 * h - 0.7034186147 * g + 1.707614701 * _ - 1,
          A = -0.0041960863 * v - 0.7034186147 * y + 1.707614701 * b,
          j = -0.0041960863 * x - 0.7034186147 * S + 1.707614701 * C,
          M = A / (A * A - 0.5 * ie * j),
          N = -ie * M;
        (T = ne >= 0 ? T : 1e6),
          (k = O >= 0 ? k : 1e6),
          (N = M >= 0 ? N : 1e6),
          (o += Math.min(T, Math.min(k, N)));
      }
    }
  }
  return o;
...
var An = {
  ...
  parse: [`--okhsl`],
  serialize: `--okhsl`,
  fromMode: { oklab: On, rgb: (e) => On(yn(e)) },
  toMode: { oklab: kn, rgb: (e) => bn(kn(e)) },
};
function jn(e) {
  ...
  return (
    v.s && (v.h = V((Math.atan2(r, n) * 180) / Math.PI)),
...
var Nn = {
  ...
  parse: [`--okhsv`],
  serialize: `--okhsv`,
  fromMode: { oklab: jn, rgb: (e) => jn(yn(e)) },
  toMode: { oklab: Mn, rgb: (e) => bn(Mn(e)) },
};
function Pn(e, t) {
  ...
  if (r.type !== E.Hue && i.type !== E.Hue && a.type !== E.Hue)
    return (
      r.type !== E.None &&
        (n.l = Math.min(
          Math.max(0, r.type === E.Number ? r.value : r.value / 100),
          1
        )),
      i.type !== E.None &&
        (n.a = i.type === E.Number ? i.value : (i.value * 0.4) / 100),
      a.type !== E.None &&
        (n.b = a.type === E.Number ? a.value : (a.value * 0.4) / 100),
      o.type !== E.None &&
        (n.alpha = Math.min(
          1,
          Math.max(0, o.type === E.Number ? o.value : o.value / 100)
...
var Fn = {
  ...Xt,
  mode: `oklab`,
  toMode: { lrgb: Q, rgb: bn },
  fromMode: { lrgb: vn, rgb: yn },
...
function In(e, t) {
  ...
  if (
    (i.type !== E.None &&
      (n.c = Math.max(
        0,
        i.type === E.Number ? i.value : (i.value * 0.4) / 100
      )),
    a.type !== E.None)
  ) {
    if (a.type === E.Percentage) return;
...
var Ln = {
    ...$t,
    mode: `oklch`,
    toMode: { oklab: (e) => K(e, `oklab`), rgb: (e) => bn(K(e, `oklab`)) },
    fromMode: { rgb: (e) => G(yn(e), `oklch`), oklab: (e) => G(e, `oklch`) },
    parse: [In],
    serialize: (e) =>
  ...
  Bn = {
    ...
    fromMode: { rgb: (e) => zn(R(e)), xyz65: zn },
    toMode: { rgb: (e) => B(Rn(e)), xyz65: Rn },
  },
  Vn = (e) => {
    const t = Math.abs(e);
    return t >= 1 / 512 ? Math.sign(e) * t ** (1 / 1.8) : 16 * e;
  },
  Hn = ({ x: e, y: t, z: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = {
      mode: `prophoto`,
      r: Vn(
      ...
      b: Vn(e * 0 + t * 0 + 1.2119675456389452 * n),
    };
    return r !== void 0 && (i.alpha = r), i;
  },
  Un = (e = 0) => {
  ...
  Gn = {
    ...
    fromMode: { xyz50: Hn, rgb: (e) => Hn(Z(e)) },
    toMode: { xyz50: Wn, rgb: (e) => X(Wn(e)) },
  },
  Kn = 1.09929682680944,
  qn = 0.018053968510807,
  Jn = (e) => {
    const t = Math.abs(e);
    return t > qn
      ? (Math.sign(e) || 1) * (Kn * t ** 0.45 - 0.09929682680944008)
      : 4.5 * e;
  },
  Yn = ({ x: e, y: t, z: n, alpha: r }) => {
    e === void 0 && (e = 0), t === void 0 && (t = 0), n === void 0 && (n = 0);
    const i = {
      mode: `rec2020`,
      r: Jn(
  ...
  Xn = 1.09929682680944,
  Zn = 0.018053968510807,
  Qn = (e = 0) => {
    const t = Math.abs(e);
    return t < Zn * 4.5
      ? e / 4.5
      : (Math.sign(e) || 1) * ((t + Xn - 1) / Xn) ** (1 / 0.45);
  },
  $n = (e) => {
    const t = Qn(e.r),
      n = Qn(e.g),
  ...
  er = {
    ...I,
    mode: `rec2020`,
    fromMode: { xyz65: Yn, rgb: (e) => Yn(R(e)) },
    toMode: { xyz65: $n, rgb: (e) => B($n(e)) },
    parse: [`rec2020`],
    serialize: `rec2020`,
  },
  ...
  rr = (e) => {
    const { r: t, g: n, b: r, alpha: i } = L(e),
      a = nr(0.3 * t + 0.622 * n + 0.078 * r + $),
      o = nr(0.23 * t + 0.692 * n + 0.078 * r + $),
      s = nr(
      ...
      c = { mode: `xyb`, x: (a - o) / 2, y: (a + o) / 2, b: s - (a + o) / 2 };
  ...
  ar = {
    ...
    interpolate: { x: P, y: P, b: P, alpha: { use: P, fixup: F } },
  },
  or = {
    mode: `xyz50`,
    parse: [`xyz-d50`],
    serialize: `xyz-d50`,
    toMode: { rgb: X, lab: qt },
    fromMode: { rgb: Z, lab: Wt },
    channels: [`x`, `y`, `z`, `alpha`],
    ranges: { x: [0, 0.964], y: [0, 0.999], z: [0, 0.825] },
    interpolate: { x: P, y: P, z: P, alpha: { use: P, fixup: F } },
  },
  sr = {
    mode: `xyz65`,
    toMode: {
  ...
  cr = {
    ...
    interpolate: { y: P, i: P, q: P, alpha: { use: P, fixup: F } },
  },
  lr = (e, t) => Math.round(e * (t = 10 ** t)) / t,
  ur = (
    (e = 4) =>
    (t) =>
      typeof t == `number` ? lr(t, e) : t
  )(2),
  dr = (e) => Math.max(0, Math.min(1, e || 0)),
  fr = (e) => Math.round(dr(e) * 255),
  pr = y(`rgb`),
  mr = (e) => {
    if (e === void 0) return;
    const t = fr(e.r),
...
var gr = y(`oklch`),
  ...
  yr = 0.19;
function br(e) {
  return { mode: `oklch`, l: vr, c: yr, h: n(e) };
}
function xr(e) {
  const t = gr(e);
...
function Sr(e) {
  if (e.shades) {
    const [t, n, r] = e.shades.map(xr);
    return { blob0: t, blob1: n, blob2: r };
  }
  const t = e.hue ?? _r,
    n = e.secondaryHue ?? t + 35;
  return { blob0: br(t), blob1: br(n), blob2: br(t - 20) };
}
function Cr(e) {
  const r = t(e.hueShift, 0, 1),
    i = t(e.intensity, 0, 1),
    a = n((e.base.h ?? 0) + Math.sin(e.time * 0.13 + e.offset) * 40 * r);
  return {
    mode: `oklch`,
    l: t(e.base.l + Math.sin(e.time * 0.21 + e.offset) * 0.1 * i, 0, 1),
    c: Math.max(
      0,
      e.base.c + Math.sin(e.time * 0.17 + e.offset * 1.3) * 0.05 * i
    ),
    h: a,
  };
}
function wr(e) {
  const n = t(e.l, 0, 1),
    r = Math.max(0, e.c),
    i = e.h ?? 0;
  return `oklch(${(n * 100).toFixed(1)}% ${r.toFixed(3)} ${i.toFixed(1)})`;
}
function Tr(e, t = 0.6) {
  return hr({ ...e, alpha: t });
}
    ...
    (0, e.defineComponent)({
      ...
      setup(t) {
        let n = t,
          ...
          s = [i, a, o],
          c = (0, e.computed)(() =>
            Sr({ shades: n.shades, hue: n.hue, secondaryHue: n.secondaryHue })
          ),
          l = (0, e.computed)(() => [
            c.value.blob0,
            c.value.blob1,
          ...
          u = (0, e.computed)(() => n.glow ?? Tr(c.value.blob0, 0.6)),
          d = 0,
          f = 0,
          p = 0,
          m = !1;
        function h(e) {
          const t = Math.min(0.05, (e - (f || e)) / 1e3);
          (f = e),
            m || (p += t),
            s.forEach((e, t) => {
              const i = e.value;
              ...
              (i.style.transform = `translate(${a.x.toFixed(2)}px, ${a.y.toFixed(2)}px) rotate(${a.rotation.toFixed(2)}deg) scale(${a.scaleX.toFixed(3)}, ${a.scaleY.toFixed(3)})`),
                (i.style.borderRadius = a.borderRadius);
              const o = Cr({
                base: l.value[t],
                time: p,
                hueShift: n.hueShift,
        ...
        return (
          ...
          (n, r) => (
            ...
            (0, e.createElementBlock)(
              ...
              [
                (0, e.createElementVNode)(`div`, Er, [
                  (0, e.createElementVNode)(
                    `div`,
                    { ref_key: `blob0El`, ref: i, class: `blob blob0` },
                    null,
                    512
                  ),
                  (0, e.createElementVNode)(
                    `div`,
                    { ref_key: `blob1El`, ref: a, class: `blob blob1` },
                    null,
                    512
                  ),
                  (0, e.createElementVNode)(
                    `div`,
                    { ref_key: `blob2El`, ref: o, class: `blob blob2` },
                    null,
                    512
                  ),
                ]),
...
function kr(t, n, r = {}) {
  let i = r.seed ?? 0,
    ...
    l = 0;
  function u(e) {
    const t = Math.min(0.05, (e - (c || e)) / 1e3);
    (c = e), (o += t);
    const r = a ? Or(o, i * 7) : 0;
    (s += (r - s) * 0.18),
      (n.value = Number(s.toFixed(3))),
  ...
  (0, e.onMounted)(() => {
    t.value?.addEventListener(`pointerenter`, d),
      t.value?.addEventListener(`pointerleave`, f),
      (l = requestAnimationFrame(u));
  }),
    (0, e.onUnmounted)(() => {
      cancelAnimationFrame(l),
        t.value?.removeEventListener(`pointerenter`, d),
        t.value?.removeEventListener(`pointerleave`, f);
    });
}
(exports.GlowOrb = Dr), (exports.useHoverPreview = kr);
